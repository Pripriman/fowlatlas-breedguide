...
class BreedCompendiumView extends StatefulWidget {
  final String endpoint;
  const BreedCompendiumView({super.key, required this.endpoint});

  @override
  State<BreedCompendiumView> createState() => _BreedCompendiumViewState();
}

class _BreedCompendiumViewState extends State<BreedCompendiumView> {
  static const _lastUrlKey = 'breed.lastUrl';
