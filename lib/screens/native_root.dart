...
import 'home/compendium_home_shell.dart';
import 'intro/welcome_deck.dart';
...
class _NativeRootState extends State<NativeRoot> {
  static const _introKey = 'breed.introDone';
  ...
  Widget build(BuildContext context) {
    switch (_stage) {
      ...
      case _Stage.intro:
        return WelcomeDeck(onDone: _finishIntro);
      case _Stage.access:
        return FlockAccessScreen(onDone: _finishAccess);
      case _Stage.home:
        return const CompendiumHomeShell();
    }
  }
}
